...
const modalWrapOpen = function (e) {
    ...
    Array.from(document.querySelectorAll(".c-block-slide__modal")).forEach(
        (e, i) => {
...
Array.from(document.querySelectorAll(".c-block-slide__figure")).forEach(
    (modalOpenElement) => {
...
const modalCloseAction = function (e) {
    const targetModal = e.currentTarget.closest(".c-block-slide__modal");
    targetModal.classList.toggle("is_open");
};

Array.from(document.querySelectorAll(".c-block-slide__close")).forEach(
    (modalCloseElement) => {
        modalCloseElement.addEventListener("click", modalCloseAction);
    }
);
Array.from(document.querySelectorAll(".c-block-slide__mask")).forEach(
    (modalCloseElement) => {
        modalCloseElement.addEventListener("click", modalCloseAction);
    }
);
